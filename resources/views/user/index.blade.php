@extends('layouts.user',['title'=>'books'])
@section('body')
    <div class="row">
        <div class="col s12">
            <div class="card">
                    ...
                    <div id="books">
                        <div class="row">
                            <div class="col s12 m6">
                                <a href="{{route('userbooks.create')}}" class="btn">
                                    Add
                                </a>
                            </div>
                        ...
                        <table id="page-length-option">
                            ...
                            @foreach($books as $book)
                                <tr>
                                    ...
                                    <td>{{$book->id}}</td>
                                    <td>
                                        <form action="{{route('userbooks.destroy',['userbook'=>$book->id])}}" method="post">
                                            @csrf
                                            @method('delete')
                                            <button class="btn btn-small btn-floating transparent">
                                                <i class="material-icons red-text">delete</i>
                                            </button>
                                            <a href="{{route('userbooks.edit',['userbook'=>$book->id])}}" class="btn btn-small btn-small btn-floating transparent">
